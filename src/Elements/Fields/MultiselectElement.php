...
class MultiselectElement extends FormSchemaBuilder
{
    protected static array $allowedAttributes = [
        ...
        'multipleLabel', 'multipleLabelSingle', 'multipleLabelMultiple', 'create',
        'appendNewOption', 'addOptionOn', 'allowAbsent', 'object',
        'limit', 'max', 'groups', 'groupLabel',
        'groupOptions', 'groupHideEmpty', 'groupSelect', 'openDirection',
        'appendToBody', 'appendTo', 'canClear', 'clearOnSelect',
        'closeOnSelect', 'closeOnDeselect', 'clearOnRefetch', 'delay',
        'minChars', 'resolveOnLoad', 'filterResults', 'clearOnSearch',
        'hideSelected', 'caret', 'loading', 'noOptionsText',
        'noResultsText', 'autocomplete', 'inputType', 'extendOptions',
        'name', 'id', 'disabled', 'attrs',
