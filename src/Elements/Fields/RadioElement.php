...
class RadioElement extends FormSchemaBuilder
{
    protected static array $allowedAttributes = [
        'type', 'container', 'wrapper', 'radioName',
        'radioValue', 'text', 'align', 'standalone',
