...
class ButtonElement extends FormSchemaBuilder
{
    protected static array $allowedAttributes = [
        'type', 'container', 'wrapper', 'buttonLabel',
        'buttonType', 'buttonClass', 'loading', 'href',
        'target', 'resets', 'submits', 'secondary',
        'danger', 'full', 'align', 'name',
        'id', 'disabled', 'label', 'info',
        'infoPosition', 'description', 'before', 'between',
        'after', 'conditions', 'columns', 'inline',
    ...
    protected static array $allowedProperties = [
        'aria', 'path', 'parent', 'available',
        'hidden', 'visible', 'isDisabled', 'isLoading',
    ...
    protected static array $allowedEventAttributes = [
        'click', 'before-create', 'created', 'before-mount',
