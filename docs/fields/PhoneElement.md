...
A form example demonstrating how to use the PhoneElement field in VueForm Laravel to capture phone numbers with automatic country flag detection. <a href="https://vueform.com/reference/phone-element" target="_blank">Documentation</a>
...
You can define custom **phone element** events <a href="https://vueform.com/reference/phone-element#events" target="_blank">Documentation</a> directly in PHP using the `->events()` method.
