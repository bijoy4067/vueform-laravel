...
You can define custom **textelement ** events <a href="https://vueform.com/reference/toggle-element#events" target="_blank">Documentation</a> directly in PHP using the `->events()` method.
