...
The following slots <a href="https://vueform.com/reference/group-element#slots" target="_blank">Documentation</a> are available for this element:
...
| `before` | - {component} el$ - the element's component | Renders an ElementText component before the group. |
| `between` | - {component} el$ - the element's component | Renders an ElementText component after the group and before description. |
