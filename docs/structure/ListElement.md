...
| `add` | - {number} index - the index of the added item<br>- {any} addedValue - the added value<br>- {array} newValue - the element value after the item is added<br>- {component} el$ - the element's component | Triggered when a new item is added to the list. |
...
The following slots <a href="https://vueform.com/reference/list-element#slots" target="_blank">Documentation</a> are available for this element:
...
| `before` | - {component} el$ - the element's component | Renders an ElementText component before the list. |
| `between` | - {component} el$ - the element's component | Renders an ElementText component after the list and before description. |
